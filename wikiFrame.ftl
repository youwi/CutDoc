...
<nav class=" buleBar col-lg-12" role="navigation">
	...
	<div class='col-md-6 myPathT '  >
		<ol class="breadcrumb myPath">
		  ...
		  <li><a href="/TestManagerPlatform/wiki"  id="gotoDeploy"  class="1active" >wiki</a></li>

		</ol>
	</div>
	<div class=' navbar-right'><small>平安付科技中心</small></div>
</nav>
...
*/
	...
	$("#save").click(function(){
		...
		$.post('/TestManagerPlatform/wiki/wikiSave', 	{wikipath:path,name:filename,wikiContent:window.frames.if.document.body.innerHTML},function(data){ alert(data);});	
	});
